...
class servidor_interface():
    ...
    def __init__(self, root=None):
        ...
        #_thread.start_new_thread(self.cliente, tuple(["null","null"]))      # Colocar dentro de um botão "CONECTAR"
    ...
    def get_ip(self):
        ...
        #return HOST, PORT      Verificar se precisa finalizar a conexão s_t
